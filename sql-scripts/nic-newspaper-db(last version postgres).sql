...
VALUES 
('Interesting article;)', current_date),
('God bless America', current_date),
('I always was crazy about space and such kind of thigs', current_date),
('Wanna rewatch Interstellar...', current_date),
('Me first!!!...', current_date),
('I love all kind of pizza, especially a big one!', current_date),
('I don''t recommend anyone even try that... think about it, you''ll be fat and unhealthy((', current_date),
('What am i do here?', current_date),
('the value of the web is embodied in the data available on it', current_date),
('In this new world of you better looking after your own data', current_date),
('Just install Kaspersky and relax', current_date),
('Let''s go CS GO!', current_date),
('Very helpful article, thx!', current_date),
('Sleep is for wimpsXD', current_date),
('Poor sleeping can literally ruin your life', current_date),
('Poor sleeping can transform you to Tyler Durdan', current_date),
('I never was abroad((', current_date),
('Travelling is the best way to reset your brains after difficult year in the office', current_date),
('So what should i choose first', current_date),
('Niceeee', current_date);
